...
namespace Application01.MenuModule
{
    public class MainMenu
    {
        ...
        public void SigninORSignup()
        {
            ...
            Console.WriteLine();
            Console.WriteLine("     ********************************************************************************************************");
            Console.WriteLine("                                     WELCOME TO HUNGRY MODE                                                 ");
            Console.WriteLine();
            Console.WriteLine("                                    !!!!!!  TASTE LASTS FOREVER !!!!!!                                        ");
            Console.WriteLine("     ********************************************************************************************************");
            Console.WriteLine();
            Console.WriteLine();
            Console.WriteLine();
            ...
            switch (intChoice)
            {
                ...
                case 2:
                    ...
                    Console.WriteLine("Enter your user name:  EX:Trifina567(length 5-11)");
                    ...
                    // Validate password
                    Console.WriteLine("Enter your password:Ex:Trifi@123");
                    Password = Console.ReadLine();
                ...
                case 3:
                    ...
                    break;
                default:
                    Console.WriteLine("CHECK YOUR DETAILS AND  TRY AGAIN");
                    SigninORSignup();
                    break;
            }
        }
